                      ...
                      <div className="flex bg-white divide-x divide-slate-200 hover:bg-slate-50 items-center">
                        ...
                        <div className="w-64 py-1 px-2 h-full">
                           {mainSpec ? (
                             ...
                             <button onClick={() => addSpecRow(sec.id, item.id)} className="text-[10px] uppercase font-bold text-slate-400 hover:text-emerald-600 tracking-wider flex items-center gap-1 cursor-pointer">+ Spec Sub-Row</button>
                           )}
                        </div>
